...
void            Font_init(void) {
    ...
    size_t count = sizeof(_fontInfoList)/sizeof(CoqFontInfo);
    const CoqFontInfo* p = &_fontInfoList[0];
    const CoqFontInfo* end = &_fontInfoList[count];
    while(p < end) {
