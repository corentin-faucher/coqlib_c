...
typedef struct _Mesh {
    ...
    uint32_t  vertices_size;      // La taille en bytes de l'array vertices.
...
Mesh*  Mesh_createEmpty(const Vertex* const verticesOpt, uint vertexCount,
                        const uint16_t* const indicesOpt, uint indexCount,
    ...
    mesh->vertices_size = (uint32_t)vertices_size;
