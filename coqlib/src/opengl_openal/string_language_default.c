...
const char *_Language_isoList[language_total_language] = {
    "fr", "en", "ja", "de",      "zh-Hans", "it", "es", "ar",
    "el", "ru", "sv", "zh-Hant", "pt",      "ko", "vi",
};
const char *_Language_nameList[language_total_language] = {
    "french",  "enghish",       "japanese",   "german", "chinese simpl.",
    "italian", "spanish",       "ararbic",    "greek",  "russian",
    "swedish", "chinese trad.", "portuguese", "korean", "vietnamese",
};
...
void Language_init(void) {
  ...
  _Language_current = Language_systemLanguage();
...
Language Language_current(void) { return _Language_current; }
...
Language Language_systemLanguage(void) { return _Language_default; }
...
bool Language_currentIs(Language other) { return other == _Language_current; }
...
char *String_createLocalizedDefault(const char *stringKey) {
  ...
  const char *locRef =
      map_valueRefOptOfKey(_localizedOfStrKeyDefault, stringKey);
  if (!locRef) {
