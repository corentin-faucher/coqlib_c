...
void     mesh_engine_deinit(Mesh* const mesh) {
...
id<MTLBuffer>  mesh_metal_indicesMTLBufferOpt(Mesh const*const mesh) {
    return (__bridge id<MTLBuffer>)mesh->_mtlIndicesBufferOpt_cptr;
}
id<MTLBuffer>  mesh_metal_verticesMTLBuffer(Mesh const*const mesh) {
