...
typedef enum {
    ...
    node_type_flag_smooth =       0x0001, // Avec smooth x, y, etc.
    ...
    node_type_flag_noChildren =   0x0200, // i.e. leaf. Utile ?
    ...
    node_type_bare =              0x0000, // node ordinaire... pas besoin d'etre downcasté.
    node_type_smooth = node_type_flag_smooth,
    node_type_leaf_drawable = node_type_flag_noChildren|node_type_flag_drawable,
    // Les boutons sont aussi smooth.
    node_type_smooth_button = node_type_flag_smooth|node_type_flag_button
    ...
    node_type_smooth_view = node_type_flag_view|node_type_flag_smooth|node_type_flag_notCopyable,
    node_type_dl_frame = node_type_flag_noChildren|node_type_flag_drawable
